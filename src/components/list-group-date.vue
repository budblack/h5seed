  ...
  <div>
    ...
    <div class="list section">
      <a class="item multi-lines with-avatar">
        ...
        <div class="content">
          <span class="title">增加卡片控件</span>
          <div>
            <small class="text-red">#新增功能</small>&nbsp;
            <small class="muted">7月5日 10:00</small>
      ...
      <a class="item multi-lines with-avatar">
        <div class="avatar circle green"><i class="icon-check"></i></div>
        <div class="content">
          <span class="title">增加轻量的路由功能</span>
          <div>
            <small class="text-red">#新增功能</small>&nbsp;
            <small class="muted">7月5日 9:00</small>
            <div class="pull-right label green">已完成</div>
          </div>
        </div>
      </a>
      <a class="item multi-lines with-avatar">
        ...
        <div class="content">
          <span class="title">整理文档</span>
          <div>
            <small class="text-yellow">#日常任务</small>&nbsp;
            <small class="muted">7月4日 9:00</small>
    ...
    <nav class="fab affix dock-bottom dock-right shadow-none dock-auto">
      <a href="https://github.com/easysoft/mzui/blob/master/doc/part/examples/list.html"
         class="btn circle shadow-2 has-margin-sm dark" target="_blank"><i class="icon-code"></i> 示例源码</a>
      <a title="新增待办" class="btn circle shadow-2 has-margin-sm btn-lg red"><i class="icon icon-plus"></i></a>
    </nav>
  </div>
</template>
<script></script>
